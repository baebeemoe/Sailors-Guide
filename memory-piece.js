      ...
      <div class="wrap memory-detail-grid">
        ...
        <div class="memory-info-panel">
          ...
          <div class="max-growth-control">
            ...
            <button id="maxGrowthToggle" class="growth-toggle ${showingMaxGrowth ? "active" : ""}" aria-pressed="${showingMaxGrowth}" aria-label="Toggle MAX Growth" ${hasMaxGrowth ? "" : "disabled"}>
              <span></span>
            </button>
          </div>
        </div>
